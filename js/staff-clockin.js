...
const CLIENT_ID = 'uz-sample-fw2w';
// v0.11.0（2026-09-06）：店舗固有 apiToken（app.js と同設計）。master GAS が発行時に注入。
const API_TOKEN = 'ec598647023140d98c7c53a3606150ca';
...
async function callGAS(action, data={}) {
  ...
  // v0.11.0：apiToken を wrappedData に同梱＝master 側 _handleUserCall_ が照合
  const wrappedData = { clientId: CLIENT_ID, apiToken: API_TOKEN, userAction: action, data };
